        ...
        function displayCart() {
            ...
            for (var i in cartArray) {
                ...
                output += "<tr>" +
                    ...
                    "<td><div class='input-group'><button class='minus-item input-group-addon btn btn-success' data-name=" + cartArray[i].name + " data-id="+ cartArray[i].id+ ">-</button>" +
                    "<input type='number' class='item-count form-control' data-name='" + cartArray[i].name + "' value='" + cartArray[i].count + "'>" +
                    "<button class='plus-item btn btn-success input-group-addon'  data-name=" + cartArray[i].name + " data-id="+ cartArray[i].id+ ">+</button></div></td>" +
