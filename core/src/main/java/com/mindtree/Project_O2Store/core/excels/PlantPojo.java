...
public class PlantPojo {
	...
	public PlantPojo(String pageName, String pagePath, String templatePath, String pageTitle, String category,
			String title, String description, String abt1, String abt2, String abt3, double price, String image,
			String offer1, String offer2, double originalPrice, double plantdId) {
		super();
	...
	public double getPlantdId() {
		return plantdId;
	}
	public void setPlantdId(double plantdId) {
		this.plantdId = plantdId;
	}
